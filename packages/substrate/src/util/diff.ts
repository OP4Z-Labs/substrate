/**
 * Tiny line-based diff helper for the v0.5 `substrate upgrade` UX.
 *
 * Why hand-rolled instead of a dep:
 *
 *   - Substrate's deps are kept minimal (commander / kleur / inquirer / yaml).
 ...
 * compressed to ~50 lines. For Substrate's use case (small markdown files,
 ...
 * `substrate upgrade --check` to show drift to the user.
 */
