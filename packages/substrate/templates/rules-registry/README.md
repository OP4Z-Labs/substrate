# Substrate rules registry

This directory is the curated public registry of rules. Rules
shipped here are merged into `substrate/RULES.yaml` for any consumer
who scaffolds them.
...
license substrate uses for content). By contributing, you agree to
that license.
