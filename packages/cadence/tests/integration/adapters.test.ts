 ...
 *
 * Exercises the spawned CLI binary so the user-visible `cadence task`
 ...
 *
 * The stub adapter is wired in by patching cadence.config.json to point
...
describe("cadence task (integration)", () => {
  let tmp: string;
